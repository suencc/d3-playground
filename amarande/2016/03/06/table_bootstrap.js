d3.select('head').append('script').attr('src','//bigdata-mindstorms.github.io/d3-playground/amarande/2016/03/06/load_bootstrap.js');

container = d3.select('body').append('div').attr('class','container');
table = container.append('table').attr('class','table production');
